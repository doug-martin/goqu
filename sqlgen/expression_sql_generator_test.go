...
func (esgs *expressionSQLGeneratorSuite) TestGenerate_BooleanExpression() {
	...
	esgs.assertCases(
		...
		expressionTestCase{val: ident.Is(true), sql: `("a" = TRUE)`},
		expressionTestCase{val: ident.Is(true), sql: `("a" = ?)`, isPrepared: true, args: []interface{}{true}},

		expressionTestCase{val: ident.Is(false), sql: `("a" = FALSE)`},
		expressionTestCase{val: ident.Is(false), sql: `("a" = ?)`, isPrepared: true, args: []interface{}{false}},

		expressionTestCase{val: ident.Is(nil), sql: `("a" = NULL)`},
		expressionTestCase{val: ident.Is(nil), sql: `("a" = ?)`, isPrepared: true, args: []interface{}{nil}},

		expressionTestCase{val: ident.IsNot(true), sql: `("a" != TRUE)`},
		expressionTestCase{val: ident.IsNot(true), sql: `("a" != ?)`, isPrepared: true, args: []interface{}{true}},

		expressionTestCase{val: ident.IsNot(false), sql: `("a" != FALSE)`},
		expressionTestCase{val: ident.IsNot(false), sql: `("a" != ?)`, isPrepared: true, args: []interface{}{false}},

		expressionTestCase{val: ident.IsNot(nil), sql: `("a" != NULL)`},
		expressionTestCase{val: ident.IsNot(nil), sql: `("a" != ?)`, isPrepared: true, args: []interface{}{nil}},
	...
	esgs.assertCases(
		...
		expressionTestCase{val: ident.Is(true), err: "goqu: boolean operator 'eq' not supported"},
		expressionTestCase{val: ident.IsNot(true), err: "goqu: boolean operator 'neq' not supported"},
...
func (esgs *expressionSQLGeneratorSuite) TestGenerate_ExpressionMap() {
	...
	esgs.assertCases(
		...
		expressionTestCase{val: exp.Ex{"a": exp.Op{"isnot": true}}, sql: `("a" != TRUE)`},
		expressionTestCase{val: exp.Ex{"a": exp.Op{"isnot": true}}, sql: `("a" != ?)`, isPrepared: true, args: []interface{}{true}},
